 ...
 */
class Identification extends \App\Entities\Images\Identification implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'occurrence', 'image', 'taxon', 'identifiedBy', 'dateIdentified', 'identificationRemarks', 'isCurrent', 'verbatimScientificName', 'matchType', 'id', 'guid', 'version', 'timestampCreated', 'timestampModified', 'createdBy', 'modifiedBy'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Identification $proxy) {
