 ...
 */
class ImageAccessPoint extends \App\Entities\Images\ImageAccessPoint implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'image', 'variant', 'accessUri', 'format', 'pixelXDimension', 'pixelYDimension', 'id', 'guid', 'version', 'timestampCreated', 'timestampModified', 'createdBy', 'modifiedBy'];
        }
