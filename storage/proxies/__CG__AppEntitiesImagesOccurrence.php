 ...
 */
class Occurrence extends \App\Entities\Images\Occurrence implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'event', 'recordedBy', 'catalogNumber', 'recordNumber', 'id', 'guid', 'version', 'timestampCreated', 'timestampModified', 'createdBy', 'modifiedBy'];
        }
