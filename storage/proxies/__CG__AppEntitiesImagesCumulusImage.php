 ...
 */
class CumulusImage extends \App\Entities\Images\CumulusImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'image', 'cumulusRecordID', 'cumulusCatalogue', 'cumulusRecordName', 'cumulusModified', 'pixelXDimension', 'pixelYDimension', 'id', 'guid', 'version', 'timestampCreated', 'timestampModified', 'createdBy', 'modifiedBy'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CumulusImage $proxy) {
