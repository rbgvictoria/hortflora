 ...
 */
class Distribution extends \App\Entities\Distribution implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'taxon', 'region', 'id', 'guid', 'version', 'createdBy', 'modifiedBy', 'timestampCreated', 'timestampModified'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Distribution $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setRegion(\App\Entities\Region $region)
    {
