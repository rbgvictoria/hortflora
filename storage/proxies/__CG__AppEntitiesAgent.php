...
class Agent extends \App\Entities\Agent implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'agentType', 'name', 'firstName', 'lastName', 'initials', 'legalName', 'ipni', 'email', 'user', 'id', 'guid', 'version', 'createdBy', 'modifiedBy', 'timestampCreated', 'timestampModified'];
        }
