 ...
 */
class Taxon extends \App\Entities\Taxon implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'parent', 'children', 'node', 'basionym', 'taxonomicStatus', 'occurrenceStatus', 'establishmentMeans', 'threatStatus', 'isEndemic', 'hybridParent1', 'hybridParent2', 'cultivars', 'horticulturalGroups', 'regions', 'name', 'taxonRank', 'nameAccordingTo', 'accepted', 'taxonRemarks', 'treatments', 'images', 'vernacularNames', 'changes', 'taxonReferences', 'id', 'guid', 'version', 'createdBy', 'modifiedBy', 'timestampCreated', 'timestampModified'];
        }
    ...
    public function getHorticulturalGroups()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHorticulturalGroups', []);

        return parent::getHorticulturalGroups();
    }
    ...
    public function addHorticulturalGroup($horticulturalGroup)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addHorticulturalGroup', [$horticulturalGroup]);

        return parent::addHorticulturalGroup($horticulturalGroup);
    }
