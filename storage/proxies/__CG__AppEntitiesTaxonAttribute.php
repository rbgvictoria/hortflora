 ...
 */
class TaxonAttribute extends \App\Entities\TaxonAttribute implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'taxon', 'attribute', 'value', 'remarks', 'id', 'guid', 'version', 'createdBy', 'modifiedBy', 'timestampCreated', 'timestampModified'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TaxonAttribute $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setAttribute(\App\Entities\Attribute $attribute)
    {
