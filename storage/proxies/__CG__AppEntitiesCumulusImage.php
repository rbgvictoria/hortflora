 ...
 */
class CumulusImage extends \App\Entities\CumulusImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'image', 'cumulusRecordID', 'cumulusCatalogue', 'cumulusRecordName', 'cumulusModified', 'pixelXDimension', 'pixelYDimension', 'id', 'guid', 'version', 'createdBy', 'modifiedBy', 'timestampCreated', 'timestampModified'];
        }
