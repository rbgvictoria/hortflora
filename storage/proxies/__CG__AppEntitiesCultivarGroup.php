 ...
 */
class CultivarGroup extends \App\Entities\CultivarGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'taxon', 'cultivars', 'name', 'taxonRank', 'nameAccordingTo', 'accepted', 'taxonRemarks', 'treatments', 'images', 'vernacularNames', 'changes', 'taxonReferences', 'id', 'guid', 'version', 'createdBy', 'modifiedBy', 'timestampCreated', 'timestampModified'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CultivarGroup $proxy) {
