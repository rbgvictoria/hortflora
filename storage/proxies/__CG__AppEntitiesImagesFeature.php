 ...
 */
class Feature extends \App\Entities\Images\Feature implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'parent', 'node_number', 'highest_descendant_node_number', 'name', 'uri', 'label', 'description', 'id', 'guid', 'version', 'timestampCreated', 'timestampModified', 'createdBy', 'modifiedBy'];
        }
