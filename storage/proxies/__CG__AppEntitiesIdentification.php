 ...
 */
class Identification extends \App\Entities\Identification implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'occurrence', 'image', 'taxon', 'identifiedBy', 'dateIdentified', 'identificationRemarks', 'isCurrent', 'verbatimScientificName', 'matchType', 'id', 'guid', 'version', 'createdBy', 'modifiedBy', 'timestampCreated', 'timestampModified'];
        }
