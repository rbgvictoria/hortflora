 ...
 */
class Region extends \App\Entities\Region implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'code', 'name', 'fullName', 'level', 'countryCode', 'parent', 'geom', 'id', 'guid', 'version', 'createdBy', 'modifiedBy', 'timestampCreated', 'timestampModified', 'nodeNumber', 'highestDescendantNodeNumber', 'depth'];
        }
