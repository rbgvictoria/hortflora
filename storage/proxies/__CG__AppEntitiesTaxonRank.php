 ...
 */
class TaxonRank extends \App\Entities\TaxonRank implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'parent', 'textBefore', 'textAfter', 'fullNameSeparator', 'isEnforced', 'isInFullName', 'rankId', 'name', 'uri', 'label', 'description', 'id', 'guid', 'version', 'createdBy', 'modifiedBy', 'timestampCreated', 'timestampModified'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TaxonRank $proxy) {
