 ...
 */
class HorticulturalGroup extends \App\Entities\HorticulturalGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'taxon', 'members', 'name', 'taxonRank', 'nameAccordingTo', 'accepted', 'taxonRemarks', 'treatments', 'images', 'vernacularNames', 'changes', 'taxonReferences', 'id', 'guid', 'version', 'createdBy', 'modifiedBy', 'timestampCreated', 'timestampModified'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HorticulturalGroup $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addMember(\App\Entities\TaxonAbstract $member)
    {
