 ...
 */
class Link extends \App\Entities\Link implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'taxon', 'source', 'baseUrl', 'path', 'query', 'id', 'guid', 'version', 'createdBy', 'modifiedBy', 'timestampCreated', 'timestampModified'];
        }
     ...
     * {@inheritDoc}
     */
    public function setSource(\App\Entities\Reference $source)
    {
    ...
    public function setBaseUrl($base)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBaseUrl', [$base]);

        return parent::setBaseUrl($base);
    }
