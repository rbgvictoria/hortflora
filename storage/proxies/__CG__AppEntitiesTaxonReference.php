 ...
 */
class TaxonReference extends \App\Entities\TaxonReference implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'taxon', 'reference', 'page', 'dateAccessed', 'id', 'guid', 'version', 'createdBy', 'modifiedBy', 'timestampCreated', 'timestampModified'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TaxonReference $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setReference(\App\Entities\Reference $reference)
    {
    ...
    public function getDateAccessed()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDateAccessed', []);

        return parent::getDateAccessed();
    }
    ...
    public function setDateAccessed($dateAccessed)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDateAccessed', [$dateAccessed]);

        return parent::setDateAccessed($dateAccessed);
    }
