 ...
 */
class TaxonAbstract extends \App\Entities\TaxonAbstract implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'name', 'taxonRank', 'nameAccordingTo', 'accepted', 'taxonRemarks', 'treatments', 'images', 'vernacularNames', 'changes', 'taxonReferences', 'id', 'guid', 'version', 'createdBy', 'modifiedBy', 'timestampCreated', 'timestampModified'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TaxonAbstract $proxy) {
