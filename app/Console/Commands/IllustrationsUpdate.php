...
class IllustrationsUpdate extends Command
{
  /**
   ...
   * @var string
   */
  protected $signature = 'hortflora:illustrations:update';
  ...
  public function handle()
  {
    ...
    if (is_dir($dir)) {
      if ($dh = opendir($dir)) {
        ...
        $service = new ImageLoaderService($filesRev[0], 'flora-illustrations');
        $service->parseFile();
        ...
        $this->info("\n");
        $this->info('Illustrations have been updated');
      }
    }
  }
}
